...
function assignValues() {
  ...
  let vysledekLpflags = vysledkyLpPgPt[0];
  let vysledekPg = vysledkyLpPgPt[1];
  let vysledekPt = vysledkyLpPgPt[2];
...
${autosidsVysledek}
${vysledekLpflags}`;
  //Vymaže prazdne řadky ve vysledku:
...
function sberDatZTabulkyNodu() {
  ...
  nodyValuePole.push(0, 0, 0, 0, 0, 0, 0, 0);
  nodyValuePole.unshift(0);
  nodyValuePoleProVypocet.push(0, 0, 0, 0, 0, 0, 0, 0);
